  ...
  try {
    ...
    await sendEmail({
      ...
      html: emailLayout({
        ...
        intro: `<strong>${brand.name}</strong> wants to collaborate with you on Muabox. Budget: <strong>${budget}</strong>. Open the deal to read their offer and reply.`,
  ...
  try {
    ...
    await sendEmail({
      ...
      html: emailLayout({
        ...
        intro: accepted
          ? `<strong>${artist.name}</strong> accepted your collab offer. Open the deal to coordinate the details.`
          : `<strong>${artist.name}</strong> declined your collab offer this time. Browse more artists who fit your launch.`,
